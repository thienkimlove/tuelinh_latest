            ...
            <div class="layout">
                <div class="layout-left">
                    ...
                    <ul class="breadCrumb clearFix">
                        ...
                        <li class="active">{{trans('common.tintuc_tieude')}}</li>
                    </ul>

                    <div class="box-news">
                        <div class="head">
                            <h1 class="title wow fade-in-left">{{trans('common.tintuc_tieude')}}</h1>
                            <p class="des wow fade-in-right">{{trans('common.tintuc_chitiet')}}</p>
                        </div>
